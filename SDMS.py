...
class Student:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Student Management System",bd=10,relief=GROOVE,font=("times new roman",40,"bold"),bg="sky Blue",fg="orange")
    ...
    #=========Manage Frame======#
        ...
        m_title=Label(Manage_Frame,text="Manage Students",bg="orange",fg="white",font=("times new roman",30,"bold"),)
        m_title.grid(row=0,columnspan=2,pady=20)

        lbl_roll=Label(Manage_Frame,text="Roll No.",bg="orange",fg="white",font=("times new roman",20,"bold"),)
        lbl_roll.grid(row=1,column=0,pady=10,padx=20,sticky="w")

        txt_Roll= Entry(Manage_Frame,textvariable=self.Roll_No_var,font=("times new roman",15,"bold"),bd=5,relief=GROOVE)
        txt_Roll.grid(row=1,column=1,padx=10,pady=20,sticky="w")

        lbl_name=Label(Manage_Frame,text="Name",bg="orange",fg="white",font=("times new roman",20,"bold"),)
        ...
        lbl_Gender=Label(Manage_Frame,text="Gender",bg="orange",fg="white",font=("times new roman",19,"bold"),)
        ...
        Combo_gender["values"]=("male","female","prefer not to say")
        Combo_gender.grid(row=4,column=1,pady=10,padx=20)

        lbl_Contact=Label(Manage_Frame,text="Contact",bg="orange",fg="white",font=("times new roman",20,"bold"),)
        lbl_Contact.grid(row=5,column=0,pady=10,padx=20,sticky="w")

        txt_Contact= Entry(Manage_Frame,textvariable=self.contact_var,font=("times new roman",15,"bold"),bd=5,relief=GROOVE)
        txt_Contact.grid(row=5,column=1,padx=10,pady=20,sticky="w")

        lbl_DOB=Label(Manage_Frame,text="D.O.B",bg="orange",fg="white",font=("times new roman",20,"bold"),)
        lbl_DOB.grid(row=6,column=0,pady=10,padx=20,sticky="w")

        txt_DOB= Entry(Manage_Frame,textvariable=self.dob_var,font=("times new roman",15,"bold"),bd=5,relief=GROOVE)
        txt_DOB.grid(row=6,column=1,padx=10,pady=20,sticky="w")
        
        lbl_Address=Label(Manage_Frame,text="Address",bg="orange",fg="white",font=("times new roman",20,"bold"),)
        lbl_Address.grid(row=7,column=0,pady=10,padx=20,sticky="w")

        self.txt_Address=Text(Manage_Frame,width=28,height=4,font=("",10))
        self.txt_Address.grid(row=7,column=1,pady=10,padx=20,sticky="w")

#=======button======
        btn_Frame=Frame(Manage_Frame,bd=4,relief=RIDGE,bg="Sky blue")
        btn_Frame.place(x=15,y=610,width=420)
    ...
    #=========detail Frame======#
        ...
        Detail_Frame.place(x=550,y=100,width=950,height=700)

        lbl_search=Label(Detail_Frame,text="Search By",bg="orange",fg="white",font=("times new roman",20,"bold"),)
...
#======Table Frame===
        ...
        Table_Frame.place(x=15,y= 70,width=900,height=600)
